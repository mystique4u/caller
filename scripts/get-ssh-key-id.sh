...
echo ""
echo "1️⃣  Update terraform/terraform.tfvars:"
echo "    ssh_key_ids = [12345678]"
echo ""
echo "2️⃣  Or if using multiple keys:"
echo "    ssh_key_ids = [12345678, 87654321]"
echo ""
echo "3️⃣  For GitHub Actions, add secret 'SSH_KEY_IDS':"
echo "    [12345678]"
echo ""
